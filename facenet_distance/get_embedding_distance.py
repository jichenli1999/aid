...
image_name1 = 'test_img/y2.jpg'  # change to your image name
image_name2 = 'test_img/y3.jpg'  # change to your image name
...
emb_array1[0, :] = sess.run(embeddings,
                            feed_dict={images_placeholder: scaled_reshape[0],
...
emb_array2[0, :] = sess.run(embeddings,
                            feed_dict={images_placeholder: scaled_reshape[1],
                                       phase_train_placeholder: False})[0]
